...
<p>This second post was entirely written as an IPython notebook. It tests some of the many awesome things IPython can do.</p>\
<p>Code samples from <a href="http://nbviewer.ipython.org/github/ipython/ipython/tree/2.x/examples/Notebook/">here</a></p>\
</div>\
</div>\
</div>\
<div class="cell border-box-sizing text_cell rendered">\
...
<div class="inner_cell">\
<div class="text_cell_render border-box-sizing rendered_html">\
<h2 id="the-probability-of-getting-k-heads-when-flipping-n-coins-is">The probability of getting (k) heads when flipping (n) coins is</h2>\
</div>\
</div>\
</div>\
<div class="cell border-box-sizing text_cell rendered">\
...
<div class="inner_cell">\
<div class="text_cell_render border-box-sizing rendered_html">\
<h1 id="inline-typesetting-mixing-markdown-and-tex">Inline Typesetting (Mixing Markdown and TeX)</h1>\
<hr />\
<p>While display equations look good for a page of samples, the ability to mix math and <em>formatted</em> <strong>text</strong> in a paragraph is also important.</p>\
<p>This expression \(\sqrt{3x-1}+(1+x)^2\) is an example of a TeX inline equation in a <strong><a href="http://daringfireball.net/projects/markdown/">Markdown-formatted</a></strong> sentence.</p>\
</div>\
</div>\
</div>\
...
<div class="highlight"><pre><span class="kn">from</span> <span class="nn">IPython.display</span> <span class="kn">import</span> <span class="n">YouTubeVideo</span><span class="p">,</span> <span class="n">Image</span>\
...
<div class="inner_cell">\
    <div class="input_area">\
<div class="highlight"><pre><span class="n">plt</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">lw</span><span class="o">=</span><span class="mi">2</span><span class="p">)</span>\
